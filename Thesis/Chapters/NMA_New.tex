...
It is likeliy that a closed-form of Equation~\ref{eq:marg} does not exist. We can therefore take a set of $N$ integration points, $\hat{x}$ from $f_{jk}$, and approximate the integral using Monte-Carlo methods, giving Equation~\ref{eq:margApprox}.
